...
void write_vtk_output(const Lattice& l, const string& filename = "test.vtk");
inline void write_vtk_output(const Lattice& l, int iterNum){write_vtk_output(l, createFilename("output_", iterNum, ".vtk"));};
